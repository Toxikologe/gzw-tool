...
const gunsmithWeapons = [
    ...
    { id: "m201c", name: "M-201C", isMeta: false, ammo: "9x18mm", type: "Pistole", tip: "Absolute Notfall-Waffe. Schnell austauschen.", base: { moa: 4.5, rpm: 350, recoil: 85, ergo: 95, noise: 0, vel: 315, reload: 1.8 }, mods: { muzzle: [], optic: [], grip: [], stock: [], mag: [] } },
...
const containersDb = [
    ...
    { category: "🔒 Secure Containers (Raid-Schutz)", name: "TAS Secure Container (3x3)", size: "9 Slots intern", source: "Elite & Supporter Edition / Artisan Level 4", isMeta: true, info: "<b>Wofür:</b> Maximaler Schutz für dicken Loot.<br><b>Kosten:</b> ~ $150.000<br><b>Kaufempfehlung:</b> Das ultimative Endgame-Ziel. Absoluter Luxus für schwere Quests und teuren Loot." },
...
// ==============================================================
// 19. PATCH NOTES / INTELLIGENCE DATABASE
// ==============================================================
const intelDatabase = [
    {
                id: "patch_0_4_1_0",
                ...
                content: `
                    <div class="classified-stamp">DECRYPTED</div>
                    <h1>EINSATZ-UPDATE: 0.4.1.0</h1>
                    <p>Commander, neue Daten vom MADFINGER-Kommando wurden entschlüsselt. Der Fokus liegt auf der ballistischen Effektivität und der Stabilisierung der Feld-Logistik.</p>
                    
                    <h2>1. BALLISTIK & MUNITION (PRIORITÄT)</h2>
                    <ul>
                        <li><strong>Durchschlagskraft:</strong> Der Einfluss des Auftreffwinkels wurde optimiert. Gut platzierte Schüsse dringen nun zuverlässiger durch Rüstung und Knochen, anstatt unrealistisch abzuprallen.</li>
                        <li><strong>Abprall-Logik:</strong> Die Winkel wurden angepasst, um die Letalität bei korrekter Zielansprache massiv zu erhöhen.</li>
                    </ul>

                    <h2>2. FEINDVERHALTEN & GAMEPLAY</h2>
                    <ul>
                        <li><strong>KI-Reaktionszeit:</strong> Feindliche Einheiten eröffnen nun ohne Verzögerung das Feuer, sobald sie nach Sichtverlust den Kontakt zum Spieler wiederherstellen.</li>
                        <li><strong>Visier-Kalibrierung:</strong> Fehler beim "Nullstellen" (Zeroing) behoben. Visiere behalten nun ihre Einstellungen nach Verlassen des Zielmodus bei.</li>
                        <li><strong>Fernglas-Lock:</strong> Ein kritischer Fehler, bei dem Soldaten nach dem Tod im Beobachtungsmodus feststeckten, wurde eliminiert.</li>
                    </ul>

                    <h2>3. LOGISTIK & FINANZEN (UI)</h2>
                    <ul>
                        <li><strong>Finanz-Logistik:</strong> Kritischer Systemabsturz beim Befüllen von teilweise gefüllten Geldbörsen wurde behoben.</li>
                        <li><strong>Inventar-Management:</strong> Gegenstände in Rucksäcken bleiben nun auch nach dem Verschachteln (Rucksack in Rucksack) voll interaktiv.</li>
                        <li><strong>Händler-Inventar:</strong> Freigeschaltete Ausrüstung von Boss-Tasks verschwindet nicht mehr aus dem Angebot der Händler.</li>
                    </ul>

                    <h2>4. TECHNISCHE OPTIMIERUNG</h2>
                    <ul>
                        <li><strong>FPS-Stabilisierung:</strong> Ein seltener Bug, der die Bildrate nach dem Respawn auf 15 FPS drosselte, wurde behoben.</li>
                        <li><strong>LOD-Rendering:</strong> Das Springen der NPC-Modelle zwischen niedriger und hoher Auflösung auf Distanz wurde korrigiert.</li>
                        <li><strong>Server-Stabilität:</strong> Diverse Speicheroptimierungen implementiert, um serverbedingte Lags zu vermeiden.</li>
                    </ul>

                    <h2>5. DIVERSE FELDKORREKTUREN</h2>
                    <ul>
                        <li>Unsichtbare Kollisionsbarriere nahe der <strong>Tiger Bay Mall (196, 129)</strong> entfernt.</li>
                        <li>Fehlerhafte Schussbahnen im Treppenhaus des <strong>Midnight Sapphire Hotels</strong> korrigiert.</li>
                        <li>Wahrscheinlichkeit für den Fund wertvoller Gegenstände (High-Value Loot) wurde global aktualisiert.</li>
                    </ul>
                    
                    <p style="margin-top:20px; color:#7ca35a; font-weight:bold;">> ENDE DER ÜBERTRAGUNG: JEDE BEWEGUNG ZÄHLT.</p>
                `
            },
            {
                id: "patch_0_4_0",
                ...
                content: `
                    <div class="classified-stamp">DECRYPTED</div>
                    <h1>MAJOR UPDATE: Spearhead</h1>
                    <p>Commander, folgende Daten wurden vom feindlichen Netzwerk abgefangen und für unsere Operationen aufbereitet.</p>
                    ...
                    <h2>FEINDLICHES VERHALTEN (KI-UPDATE)</h2>
                    <ul>
                        <li>Gegnerische Einheiten reagieren nun aggressiver auf Schalldämpfer-Schüsse aus unter 50 Metern.</li>
                        <li>Sichtkegel der Wachen in Fort Narith wurde um 15% reduziert bei starkem Regen.</li>
                    </ul>

                    <h2>TERRAIN & LOGISTIK</h2>
                    <ul>
                        <li>Neue Landezonen (LZs) am Rand von Tiger Bay eingerichtet.</li>
                        <li>Kollisionsfehler bei den Helikoptern (Phase-Through) wurde behoben.</li>
                    </ul>
                `
            },
            {
                ...
                content: `
                    <div class="classified-stamp">ARCHIVED</div>
                    <h1>HOTFIX: Performance & Crashes</h1>
                    <p>Kurzes Briefing zur Serverstabilität:</p>
                    <h2>SYSTEM-ANPASSUNGEN</h2>
                    <ul>
                        <li>Memory Leak beim Öffnen des Inventars wurde gefixt.</li>
                        <li>Easy Anti-Cheat (EAC) Timeouts wurden reduziert.</li>
                        <li>Der "Headless"-Bug (Fehlender Kopf nach dem Spawnen) wurde eliminiert.</li>
                    </ul>
                `
            }
        ];
