...
const logisticsDb = [
    ...
    { name: "PBG-01+ Drohnen-Kontrollstation", category: "Hochwertige Technologie", vendor: "Alle", price: 6400, grid: "2x2", weight: "14.2 kg", isQuest: true, questInfo: "Wichtiges Drohnen-Equipment (Mission)" },
    ...
    { name: "Verstärkter Militär-Laptop", category: "Hochwertige Technologie", vendor: "Alle", price: 2300, grid: "2x2", weight: "2.5 kg", isQuest: true, questInfo: "Tech Recovery (Lab Rat / Handshake)" },
    ...
    { name: "Stange Tahirs Zigaretten", category: "Wertsachen", vendor: "Alle", price: 27, grid: "3x1", weight: "0.25 kg", isQuest: true, questInfo: "Supply Request" },
    { name: "Tahirs Zigaretten", category: "Wertsachen", vendor: "Gunny", price: 5, grid: "1x1", weight: "0.013 kg", isQuest: false, questInfo: "" },
    { name: "Goldkette", category: "Wertsachen", vendor: "Banshee / Vulture", price: 0, grid: "1x1", weight: "0.1 kg", isQuest: true, questInfo: "Black Market (5x)" },
    { name: "Holzstatue", category: "Wertsachen", vendor: "Turncoat / Artisan", price: 0, grid: "1x2", weight: "0.5 kg", isQuest: true, questInfo: "Hazardous Treasures (3x)" },
    { name: "Goldene Uhr (Rolex)", category: "Wertsachen", vendor: "Turncoat", price: 0, grid: "1x1", weight: "0.1 kg", isQuest: true, questInfo: "Bribe Money (2x)" },
    ...
    { name: "Touristen-Reisepass", category: "Geheimdienst & Dokumente", vendor: "Alle", price: 2600, grid: "1x1", weight: "0.05 kg", isQuest: true, questInfo: "Smuggling Route (Banshee) - 2x" },
    ...
    { name: "Biometrischer USB-Stick", category: "Geheimdienst & Dokumente", vendor: "Alle", price: 1900, grid: "1x1", weight: "0.004 kg", isQuest: true, questInfo: "Data Extraction (Handshake) - 3x" },
    ...
    { name: "Geschäftsmann-Ausweis", category: "Geheimdienst & Dokumente", vendor: "Alle", price: 937, grid: "1x1", weight: "0.05 kg", isQuest: true, questInfo: "Target Identification" },
    ...
    { name: "Touristen-Ausweis", category: "Geheimdienst & Dokumente", vendor: "Alle", price: 112, grid: "1x1", weight: "0.05 kg", isQuest: true, questInfo: "Identification" },
    ...
    { name: "Verschlüsselte Festplatte", category: "Elektronik", vendor: "Lab Rat", price: 1200, grid: "1x1", weight: "0.2 kg", isQuest: true, questInfo: "Tech Recovery / Intel" },
    ...
    { name: "Spiegelreflexkamera (DSLR)", category: "Elektronik", vendor: "Alle", price: 960, grid: "1x2", weight: "0.95 kg", isQuest: true, questInfo: "Paparazzi (Banshee) - 2x" },
    ...
    { name: "AZART P1 Funkgerät", category: "Elektronik", vendor: "Alle", price: 825, grid: "2x1", weight: "0.72 kg", isQuest: true, questInfo: "Comms Sabotage / Setup" },
    { name: "Laptop", category: "Elektronik", vendor: "Alle", price: 750, grid: "2x2", weight: "1.5 kg", isQuest: true, questInfo: "Tech Recovery (Lab Rat)" },
    ...
    { name: "Digitalkamera (DigiCam)", category: "Elektronik", vendor: "Alle", price: 112, grid: "1x1", weight: "0.35 kg", isQuest: true, questInfo: "Smile for the Camera (Banshee) - 4x" },
    { name: "Handy-Ladegerät", category: "Elektronik", vendor: "Alle", price: 9, grid: "1x1", weight: "0.075 kg", isQuest: false, questInfo: "" },
    
    // --- WERKZEUGE & MATERIALIEN ---
    { name: "Weißes Lithiumfett", category: "Werkzeuge & Materialien", vendor: "Alle", price: 150, grid: "3x2", weight: "15.88 kg", isQuest: true, questInfo: "Smooth Operation (Artisan) - 3x" },
    { name: "Werkzeugset", category: "Werkzeuge & Materialien", vendor: "Alle", price: 142, grid: "2x2", weight: "1.6 kg", isQuest: true, questInfo: "Tooling Up / The Builder - 5x" },
    ...
    { name: "Minderwertiges Schießpulver", category: "Werkzeuge & Materialien", vendor: "Alle", price: 23, grid: "2x1", weight: "0.45 kg", isQuest: true, questInfo: "Explosive Material (Gunny) - 2x" },
    { name: "Bremsflüssigkeit", category: "Werkzeuge & Materialien", vendor: "Alle", price: 21, grid: "2x2", weight: "3.8 kg", isQuest: false, questInfo: "" },
    { name: "Benzinkanister", category: "Werkzeuge & Materialien", vendor: "Alle", price: 21, grid: "2x2", weight: "5 kg", isQuest: true, questInfo: "Fuel Run (Artisan) - 2x" },
    ...
    { name: "Tarnstoff", category: "Werkzeuge & Materialien", vendor: "Alle", price: 10, grid: "2x1", weight: "0.48 kg", isQuest: true, questInfo: "Gear Crafting / Hideout" },
    ...
    { name: "Kupferkabel", category: "Werkzeuge & Materialien", vendor: "Artisan", price: 0, grid: "1x2", weight: "1 kg", isQuest: true, questInfo: "Scrapyard (5x)" },
    { name: "Nägel", category: "Werkzeuge & Materialien", vendor: "Artisan", price: 0, grid: "1x1", weight: "0.5 kg", isQuest: true, questInfo: "Supply Shortage (2x)" },
    { name: "Panzertape", category: "Werkzeuge & Materialien", vendor: "Artisan", price: 0, grid: "1x1", weight: "0.2 kg", isQuest: true, questInfo: "Supply Shortage, The Builder (5x)" },
    { name: "Waffenteile", category: "Werkzeuge & Materialien", vendor: "Artisan", price: 0, grid: "2x1", weight: "1 kg", isQuest: true, questInfo: "Maintenance Contract (Daily) (5x)" },
    { name: "Zündkerze", category: "Werkzeuge & Materialien", vendor: "Artisan", price: 0, grid: "1x1", weight: "0.2 kg", isQuest: true, questInfo: "Mechanic's Trouble (2x)" },
    ...
    { name: "Desinfektionsmittel", category: "Medizin & Survival", vendor: "Alle", price: 199, grid: "1x1", weight: "1 kg", isQuest: true, questInfo: "Medical Supply" },
    ...
    { name: "Blutbeutel 500ml", category: "Medizin & Survival", vendor: "Lab Rat", price: 0, grid: "1x2", weight: "0.5 kg", isQuest: true, questInfo: "Blood Donation (3x)" },
    { name: "Morphin-Injektor", category: "Medizin & Survival", vendor: "Lab Rat", price: 0, grid: "1x1", weight: "0.1 kg", isQuest: true, questInfo: "Medical Supplies (5x)" },
    ...
    { name: "Wasserproben", category: "Medizin & Survival", vendor: "Lab Rat", price: 0, grid: "1x1", weight: "0.2 kg", isQuest: true, questInfo: "Biohazard Contract (3x)" },
    ...
    { name: "Wasserreinigungstabletten", category: "Medizin & Survival", vendor: "Alle", price: 27, grid: "1x1", weight: "1.25 kg", isQuest: true, questInfo: "Survival Prep" },
    ...
    { name: "M4A1 Sturmgewehr", category: "Sonstiges", vendor: "Gunny / Turncoat", price: 0, grid: "2x4", weight: "3.5 kg", isQuest: true, questInfo: "Brothers in Arms / In The Right Hands (4x)" },
    { name: "Unmodifizierte AKMN", category: "Sonstiges", vendor: "Artisan", price: 0, grid: "2x5", weight: "3.8 kg", isQuest: true, questInfo: "Save the Rebellion (3x)" }
];
